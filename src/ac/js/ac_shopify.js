...
ACTIMBER = {
    ...
    fn:{
        ...
        acStateOn: function(container, showButton, parent, listParent ){
        ...
        acStateOff: function(container, showButton, parent, listParent){
        ...
        actStateToggle: function (container, showButton, parent, listParent) {
            ...
            showButton.on('click', function(e){
                ...
                if ('off' === elState ) {
                   ACTIMBER.fn.acStateOn(container, showButton, parent, listParent);
                } else {
                    ACTIMBER.fn.acStateOff(container, showButton, parent, listParent);
                }
            });
        },
